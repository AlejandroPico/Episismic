...
type InspectorTab = 'summary' | 'data' | 'focal' | 'sequence' | 'waves' | 'revisions' | 'compare';
...
const tabs: Array<{ id: InspectorTab; label: string }> = [
  ...
  { id: 'sequence', label: 'Secuencia' }, { id: 'waves', label: 'Ondas' }, { id: 'revisions', label: 'Revisiones' }, { id: 'compare', label: 'Comparar' },
];
